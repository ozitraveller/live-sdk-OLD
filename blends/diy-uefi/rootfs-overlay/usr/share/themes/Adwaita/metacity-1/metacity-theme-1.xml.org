...
<draw_ops name="border">
	<line color="gtk:bg[NORMAL]" x1="0" y1="0" x2="width" y2="0"/>
	<line color="shade/gtk:bg[NORMAL]/1.18" x1="5" y1="1" x2="width-5" y2="1"/>
</draw_ops>
...
<!-- ::: TITLES ::: -->
<draw_ops name="title">
	<title color="shade/gtk:bg[NORMAL]/1.30" x="3 `max` (width-title_width)/2-26" y="1 `max` ((height-title_height)/2)+1"/>
	<title color="shade/gtk:bg[NORMAL]/0.50" x="3 `max` (width-title_width)/2-26" y="0 `max` ((height-title_height)/2)"/>
</draw_ops>

<draw_ops name="title_unfocused">
	<title color="shade/gtk:bg[NORMAL]/1.15" x="4 `max` (width-title_width)/2-25" y="1 `max` ((height-title_height)/2)+1"/>
	<title color="shade/gtk:bg[NORMAL]/0.70" x="3 `max` (width-title_width)/2-26" y="0 `max` ((height-title_height)/2)"/>
</draw_ops>
